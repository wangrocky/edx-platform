...
class TestVerifyStudentCommand(MockS3Mixin, TestCase):
    ...
    @patch('lms.djangoapps.verify_student.management.commands.send_expired_status_emails.IDVerificationService.user_status')
    def test_send_expired_status_emails_with_expired_status(self, mock_user_status, mock_sailthru_send):
        """
    ...
    @patch('sailthru.sailthru_client.SailthruClient.send')
    @patch('lms.djangoapps.verify_student.management.commands.send_expired_status_emails.IDVerificationService.user_status')
    def test_send_expired_status_emails_with_unexpired_status(self, mock_user_status, mock_sailthru_send):
        """
